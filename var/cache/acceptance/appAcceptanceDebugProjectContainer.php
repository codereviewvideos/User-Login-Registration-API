...
/**
 * appAcceptanceDebugProjectContainer.
 *
...
class appAcceptanceDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'csa_guzzle.client.local_test_api' => 'getCsaGuzzle_Client_LocalTestApiService',
            'csa_guzzle.data_collector.guzzle' => 'getCsaGuzzle_DataCollector_GuzzleService',
            'csa_guzzle.middleware.history' => 'getCsaGuzzle_Middleware_HistoryService',
            'csa_guzzle.middleware.logger' => 'getCsaGuzzle_Middleware_LoggerService',
            'csa_guzzle.middleware.stopwatch' => 'getCsaGuzzle_Middleware_StopwatchService',
            ...
            'event.jwt_created_listener' => 'getEvent_JwtCreatedListenerService',
            ...
            'security.user_checker.api_login' => 'getSecurity_UserChecker_ApiLoginService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.api' => 'security.user_checker.api_login',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MU28f4dCqi', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2dPlw0yQNk', 0, 'xejGiFkv1rFq6iC-1yzjLw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oEhkcJ1vFv', 0, 'xejGiFkv1rFq6iC-1yzjLw', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CuRNNx3b1u', 0, 'xejGiFkv1rFq6iC-1yzjLw', (__DIR__.'/pools'), $a));
    ...
    /**
     * Gets the 'csa_guzzle.client.local_test_api' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getCsaGuzzle_Client_LocalTestApiService()
    {
        ...
        return $this->services['csa_guzzle.client.local_test_api'] = new \GuzzleHttp\Client(array('base_uri' => 'http://api.rest-user-api.dev/app_acceptance.php/', 'on_stats' => array(0 => $this->get('csa_guzzle.data_collector.guzzle'), 1 => 'addStats'), 'handler' => $a));
    }
    ...
    {
        return $this->services['csa_guzzle.data_collector.guzzle'] = new \Csa\Bundle\GuzzleBundle\DataCollector\GuzzleCollector(65536);
    }

    /**
     * Gets the 'csa_guzzle.middleware.history' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getCsaGuzzle_Middleware_HistoryService()
    {
        return $this->services['csa_guzzle.middleware.history'] = \Csa\Bundle\GuzzleBundle\GuzzleHttp\Middleware::history($this->get("csa_guzzle.data_collector.guzzle")->getHistory());
    }

    /**
     * Gets the 'csa_guzzle.middleware.logger' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Closure A Closure instance
     */
    protected function getCsaGuzzle_Middleware_LoggerService()
    {
        return $this->services['csa_guzzle.middleware.logger'] = \GuzzleHttp\Middleware::log($this->get('logger'), new \GuzzleHttp\MessageFormatter('{hostname} {req_header_User-Agent} - [{date_common_log}] "{method} {target} HTTP/{version}" {code} {res_header_Content-Length}'), 'debug');
    }

    /**
     * Gets the 'csa_guzzle.middleware.stopwatch' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Closure A Closure instance
     */
    protected function getCsaGuzzle_Middleware_StopwatchService()
    {
        return $this->services['csa_guzzle.middleware.stopwatch'] = \Csa\Bundle\GuzzleBundle\GuzzleHttp\Middleware::stopwatch($this->get('debug.stopwatch'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('lexik_jwt_authentication.on_jwt_created', array(0 => 'event.jwt_created_listener', 1 => 'onJWTCreated'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'code_review_db_rest_user_api_acceptance', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_541631d796bc81e2081e0da8c468d626af7d96359a0a34ea5acc4a2088c3bbd5');
    ...
    /**
     * Gets the 'event.jwt_created_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Event\Listener\JWTCreatedListener A AppBundle\Event\Listener\JWTCreatedListener instance
     */
    protected function getEvent_JwtCreatedListenerService()
    {
        return $this->services['event.jwt_created_listener'] = new \AppBundle\Event\Listener\JWTCreatedListener($this->get('security.token_storage'));
    }
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'json'), 'fallback_format' => 'json', 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => array(), 'stop' => false));
    ...
    {
        return $this->services['fos_user.security.login_manager'] = new \FOS\UserBundle\Security\LoginManager($this->get('security.token_storage'), $this->get('security.user_checker.api_login'), $this->get('security.authentication.session_strategy'), $this);
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Resources/config/serializer'), 'Nelmio\\CorsBundle' => ($this->targetDirs[3].'/vendor/nelmio/cors-bundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Knp\\Bundle\\PaginatorBundle' => ($this->targetDirs[3].'/vendor/knplabs/knp-paginator-bundle/Resources/config/serializer'), 'Lexik\\Bundle\\JWTAuthenticationBundle' => ($this->targetDirs[3].'/vendor/lexik/jwt-authentication-bundle/Lexik/Bundle/JWTAuthenticationBundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer'), 'Csa\\Bundle\\GuzzleBundle' => ($this->targetDirs[3].'/vendor/csa/guzzle-bundle/src/Resources/config/serializer')));
    ...
    {
        return $this->services['lexik_jwt_authentication.openssl_key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\OpenSSLKeyLoader(($this->targetDirs[3].'/app/var/jwt/private.pem'), ($this->targetDirs[3].'/app/var/jwt/public.pem'), 'changeme');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/logs/acceptance.log'), 100, true, NULL);
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.api_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        $b->setDispatcher($this->get('debug.event_dispatcher'));
    ...
    /**
     * Gets the 'security.firewall.map.context.api_login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getSecurity_Firewall_Map_Context_ApiLoginService()
    {
        ...
        return $this->services['security.firewall.map.context.api_login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout')), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $c, $this->get('security.authentication.session_strategy'), $a, 'api_login', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('lexik_jwt_authentication.handler.authentication_success'), array('always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'api_login'), new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationFailureHandler($this->get('lexik_jwt_authentication.handler.authentication_failure'), array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path')), array('check_path' => '/login', 'require_previous_session' => false, 'username_parameter' => 'username', 'password_parameter' => 'password', 'use_forward' => false, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $d, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5a5356ab4d7689.74721574', $d, $c), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'api_login', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $a, '/login', false), NULL, NULL, $d, true));
    }
    ...
    /**
     * Gets the 'security.user_checker.api_login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_UserChecker_ApiLoginService()
    {
        return $this->services['security.user_checker.api_login'] = new \Symfony\Component\Security\Core\User\UserChecker();
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler(($this->targetDirs[3].'/app/../var/sessions/acceptance'));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $c = new \FOS\UserBundle\Security\EmailUserProvider($b);
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($c, $this->get('security.user_checker.api_login'), 'api_login', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a5356ab4d7689.74721574'), 2 => $d), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('api_login', '/logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'appAcceptanceDebugProjectContainer',
            ...
            'session.save_path' => ($this->targetDirs[3].'/app/../var/sessions/acceptance'),
            ...
            'router.options.matcher.cache_class' => 'appAcceptanceUrlMatcher',
            'router.options.generator.cache_class' => 'appAcceptanceUrlGenerator',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => ($this->targetDirs[3].'/app/config/routing_dev.yml'),
            'router.cache_class_prefix' => 'appAcceptance',
            'request_listener.http_port' => 80,
            'request_listener.https_port' => 443,
            'debug.error_handler.throw_at' => -1,
            'debug.container.dump' => (__DIR__.'/appAcceptanceDebugProjectContainer.xml'),
            ...
            'lexik_jwt_authentication.pass_phrase' => 'changeme',
